...
in
{
  ...
  programs.zsh = {
    ...
    shellAliases = {
      ...
      nrs = "sudo nixos-rebuild switch --flake . && sudo systemctl restart home-manager-prepko.service";
  ...
  programs.hyprlock = {
    ...
    settings = {
      ...
      # Near-black background — no blur, just crush the screenshot brightness
      # so the flat Paper Mario elements pop against a dark substrate.
      background = [
        {
          path        = "screenshot";
          blur_passes = 0;
      ...
      image = [
        {
          ...
          rounding    = 8;
          border_size = 5;
          border_color = "rgba(196, 167, 231, 1.0)";  # IRIS — cel-shaded outline
          position    = "0, 0";
          halign      = "center";
          valign      = "center";
        }
      ...
      label = [
        # ── Clock ───────────────────────────────────────────────────
        # Shadow copy rendered first (lower layer), offset (+5, -5) = right + down
        {
        ...
        {
          text        = "cmd[update:60000] echo \"$(date +\"%A, %d %B\")\"";
          color       = "rgba(156, 207, 216, 1.0)";  # FOAM
          font_size   = 24;
          font_family = "JetBrainsMono Nerd Font";
          position    = "0, 222";
          halign      = "center";
        ...
        {
          text        = "cmd[update:2000] ${config.xdg.configHome}/waybar/scripts/mpris_status.sh 2>/dev/null | jq -r '.text // \"\"'";
          color       = "rgba(224, 222, 244, 1.0)";  # TEXT
          font_size   = 24;
          font_family = "JetBrainsMono Nerd Font";
          position    = "0, -215";
          halign      = "center";
        ...
        # ── MPRIS artist/album (quieter, no shadow) ──────────────────
        {
        ...
        {
          text        = "cmd[update:300000] waybar-weather --mode default 2>/dev/null | jq -r '.text // \"\"'";
          color       = "rgba(234, 154, 151, 1.0)";  # ROSE
          font_size   = 24;
          font_family = "JetBrainsMono Nerd Font";
          position    = "0, 75";
          halign      = "center";
      ...
      input-field = [
        {
          ...
          dots_spacing      = 0.35;
          dots_center       = true;
          outer_color       = "rgba(196, 167, 231, 1.0)";  # IRIS
          inner_color       = "rgba(15, 13, 26, 0.98)";    # near-solid dark
          font_color        = "rgb(224, 222, 244)";
          fade_on_empty     = true;
          rounding          = 6;
          check_color       = "rgb(246, 193, 119)";   # GOLD
