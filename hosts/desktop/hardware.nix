...
# MACHINE-SPECIFIC — generated by nixos-generate-config for this desktop (i5-9600K).
# If forking: run `nixos-generate-config` on your machine and replace this file,
# or at minimum replace the LUKS UUIDs and filesystem UUIDs with your own values.
